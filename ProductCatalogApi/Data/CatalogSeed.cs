...
namespace ProductCatalogApi.Data
{
    public static class CatalogSeed
    {
        ...
        public static void Seed(CatalogeContext context) 
        {
            context.Database.Migrate();
            if (!context.CatalogeTypes.Any())
            {
                context.CatalogeTypes.AddRange(GetCatalogTypes());
                context.SaveChanges();
            }
        ...
        { 
            ...
            { new CatalogType{Type ="Engagement Ring"},
                ...
                new CatalogType{Type="Fasion Ring"},
        ...
        private static IEnumerable<CatalogItem> GetCatalogItems()
        {
            return new List<CatalogItem>
                { new CatalogItem { CatalogTypeId = 2, CatalogBrandId = 3, Description = "A ring that has been around for over 100 years", Name = "World Star", Price = 199, PictureUrl = "http://externalcatalogbaseurltobereplaced/api/pic/1" },
                new CatalogItem { CatalogTypeId = 1, CatalogBrandId = 2, Description = "will make you world champions", Name = "White Line", Price = 88, PictureUrl = "http://externalcatalogbaseurltobereplaced/api/pic/2" },
                ...
                new CatalogItem { CatalogTypeId = 2, CatalogBrandId = 1, Description = "Roslyn Red Sheet", Name = "Roslyn White", Price = 188, PictureUrl = "http://externalcatalogbaseurltobereplaced/api/pic/5" },
                ...
                new CatalogItem { CatalogTypeId = 1, CatalogBrandId = 1, Description = "Light as carbon", Name = "Deep Purple", Price = 238, PictureUrl = "http://externalcatalogbaseurltobereplaced/api/pic/8" },
                ...
                new CatalogItem { CatalogTypeId = 1, CatalogBrandId = 2, Description = "All round", Name = "Inredeible", Price = 248, PictureUrl = "http://externalcatalogbaseurltobereplaced/api/pic/11" },
                ...
                new CatalogItem { CatalogTypeId = 3, CatalogBrandId = 2, Description = "A ring popular in the 16th and 17th century in Western Europe that was used as an engagement wedding ring", Name = "London Star", Price = 218, PictureUrl = "http://externalcatalogbaseurltobereplaced/api/pic/14" },
